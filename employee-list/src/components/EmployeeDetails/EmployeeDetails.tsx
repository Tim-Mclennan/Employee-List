  ...
  return (
    <div className={styles.EmployeeDetails}>
        ...
        <form  className={styles.EmployeeDetails__Form} onSubmit={handleSubmit}>
            ...
            <input type="tel" name="mobile" id="mobile" placeholder="Mobile" value={formData.mobile} onChange={handleInputChange} />
            ...
            <div className={styles.EmployeeDetails__Form__Contract}>
                ...
                <div>
                    <input type="radio" id="contract" name="contractType" value="Contract" checked={formData.contractType === "Contract"}
            ...
            <input type="date" name="startDate" id="startDate" placeholder="Start Date" value={formData.startDate} onChange={handleInputChange}/>
            
            <label htmlFor="endDate">End Date:</label>
            <input type="date" name="endDate" id="endDate" placeholder="End Date" value={formData.endDate} onChange={handleInputChange}/>
            ...
            <input type="number" name="hoursPerWeek" id="hoursPerWeek" placeholder="Hours Per Week" value={formData.hoursPerWeek} onChange={handleInputChange}/>
            <div>
